...
import { clearStoredLoginData, getStoredLoginData, setStoredLoginData } from "./local-storage";
...
export const AuthContextProvider = ({ children }: React.PropsWithChildren<object>) => {
  ...
  return <AuthContext.Provider value={{ userId, userToken, clearLoginData, setLoginData }}>{children}</AuthContext.Provider>;
};
